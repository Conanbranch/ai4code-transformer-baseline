...
The code cells are sampled so they are evenly spaced (aside from the second to last and last cell) and the order of the code cells are preserved. The first and last code cell are always included.
